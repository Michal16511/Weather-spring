				...
				<div class="forecast-container">
					<div class="today forecast">
						...
						<div class="forecast-content">
							...
							<div class="degree">
								<div class="num">
									${temperature[1]}<sup>o</sup>C
								</div>
								<div class="forecast-icon">
									<c:if
									test="${fn:contains(description[1], 'Zachmurzenie całkowite')}">
									<img src="<c:url value="/resources/images/icons/icon-6.svg" />"
										alt="" width=90>
								</c:if>
								<c:if
									test="${fn:contains(description[1], 'Pochmurno, słabe opady deszczu')}">
									<img src="<c:url value="/resources/images/icons/icon-4.svg" />"
										alt="" width=90>
								</c:if>
								<c:if
									test="${fn:contains(description[1], 'Bezchmurnie')}">
									<img src="<c:url value="/resources/images/icons/icon-2.svg" />"
										alt="" width=48>
								</c:if>

								<c:choose>
									<c:when test="${fn:contains(description[1], 'Pogodnie')}">

										<c:choose>
											<c:when
												test="${fn:contains(description[1], 'Pogodnie, okresami wzrost zachmurzenia do umiarkowanego')}">
								...
								<c:if
									test="${fn:contains(description[1], 'Zachmurzenie małe, możliwe słabe opady deszczu')}">
									<img src="<c:url value="/resources/images/icons/icon-4.svg" />"
										alt="" width=90>
								</c:if>
								<c:if
									test="${fn:contains(description[1], 'Pochmurno z przejaśnieniami, słabe opady deszczu')}">
									<img src="<c:url value="/resources/images/icons/icon-4.svg" />"
										alt="" width=90>
								</c:if>
								<c:if
									test="${fn:contains(description[1], 'Pochmurno, okresami przejaśnienia')}">
					...
					<div class="forecast">
						...
						<div class="forecast-content">
							...
							<div class="forecast-icon">
								...
								<c:if
									test="${fn:contains(description[i+3], 'Zachmurzenie całkowite')}">
									<img src="<c:url value="/resources/images/icons/icon-6.svg" />"
										alt="" width=48>
								</c:if>
								<c:if
									test="${fn:contains(description[i+3], 'Pochmurno, słabe opady deszczu')}">
									<img src="<c:url value="/resources/images/icons/icon-4.svg" />"
										alt="" width=48>
								</c:if>
								
								<c:if
									test="${fn:contains(description[i+3], 'Bezchmurnie')}">
									<img src="<c:url value="/resources/images/icons/icon-2.svg" />"
										alt="" width=48>
								</c:if>
								...
								<c:choose>
									<c:when test="${fn:contains(description[i+3], 'Pogodnie')}">

										<c:choose>
											<c:when
												test="${fn:contains(description[i+3], 'Pogodnie, okresami wzrost zachmurzenia do umiarkowanego')}">
								...
								<c:if
									test="${fn:contains(description[i+3], 'Zachmurzenie małe, możliwe słabe opady deszczu')}">
									<img src="<c:url value="/resources/images/icons/icon-4.svg" />"
										alt="" width=48>
								</c:if>
								<c:if
									test="${fn:contains(description[i+3], 'Pochmurno z przejaśnieniami, słabe opady deszczu')}">
									<img src="<c:url value="/resources/images/icons/icon-4.svg" />"
										alt="" width=48>
								</c:if>
								<c:if
									test="${fn:contains(description[i+3], 'Pochmurno, okresami przejaśnienia')}">
									<img src="<c:url value="/resources/images/icons/icon-3.svg" />"
										alt="" width=48>
								</c:if>
